...
BOOST_AUTO_TEST_CASE(ConstructAndCompare)
{
	...
	BOOST_TEST(moveDestination.serialize() == "\"testValue\"");
...
BOOST_AUTO_TEST_CASE(Iterators)
{
	...
	std::string testBatchObjectExpect = "{\"testValue1\":1,\"testValue2\":2,\"testValue3\":3,\"testValue4\":5,\"testValue5\":8}";
	...
	BOOST_TEST(testBatchObject.serialize() == "{\"testValue1\":1,\"testValue2\":2,\"testValue4\":5,\"testValue5\":8}");
