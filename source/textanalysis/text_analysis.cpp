...
//Funkcja wracająca od punktu end do najbliższego znaku interpunkcyjnego
...
//Funkcja sprawdzająca czy są samogłoski w zdaniu
...
//Funkcja sprawdzająca spacje w zdaniu
...
std::vector<Markers> findQA(std::string text)
{
    ...
    for (std::size_t i = 0; i < text.size(); ++i)
    {
        ...
        if (text[i] == '?')
        {
            ...
            //"Cofanie się" dopoki nie znajdzie sie znaku interpunkcyjnego lub poczatku
    ...
    /*W przypadku gdy tekst jest bez zadnej interpunkcji wykonuje się ta bardziej "zaawansowana" czesc analizy.
